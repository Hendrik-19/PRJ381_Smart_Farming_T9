...
namespace Smart_Farming.BusinessLogic
{
    class CropSuggestion
    {
        ...
        public List<Crop> getCrops(Location loc)
        {
            ...
            //TODO: Use dummyvalues.getcroplist to get croplist and check the climate_id property of the crops to see if it matches location assigned climate and return it
